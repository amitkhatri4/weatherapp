...
// api request and serching part for weather to show the weather of any city 
    fetch('https://api.openweathermap.org/data/2.5/weather?q='+CityName1.value+'&appid=8a254d73f460a4c7bf9d2b36c3b1a586')
...
fetch('https://api.openweathermap.org/data/2.5/weather?q=tikapur&appid=8a254d73f460a4c7bf9d2b36c3b1a586')
.then(response => response.json())
